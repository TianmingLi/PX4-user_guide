...
<a id="#ARM_DISARM_REASON_TRANSITION_TO_STANDBY"></a> ARM_DISARM_REASON_TRANSITION_TO_STANDBY | `uint8` | 0 | 
...
<a id="#ARM_DISARM_REASON_SAFETY_BUTTON"></a> ARM_DISARM_REASON_SAFETY_BUTTON | `uint8` | 6 | 
<a id="#ARM_DISARM_REASON_AUTO_DISARM_LAND"></a> ARM_DISARM_REASON_AUTO_DISARM_LAND | `uint8` | 7 | 
<a id="#ARM_DISARM_REASON_AUTO_DISARM_PREFLIGHT"></a> ARM_DISARM_REASON_AUTO_DISARM_PREFLIGHT | `uint8` | 8 | 
<a id="#ARM_DISARM_REASON_KILL_SWITCH"></a> ARM_DISARM_REASON_KILL_SWITCH | `uint8` | 9 | 
<a id="#ARM_DISARM_REASON_LOCKDOWN"></a> ARM_DISARM_REASON_LOCKDOWN | `uint8` | 10 | 
<a id="#ARM_DISARM_REASON_FAILURE_DETECTOR"></a> ARM_DISARM_REASON_FAILURE_DETECTOR | `uint8` | 11 | 
<a id="#ARM_DISARM_REASON_SHUTDOWN"></a> ARM_DISARM_REASON_SHUTDOWN | `uint8` | 12 | 
<a id="#ARM_DISARM_REASON_UNIT_TEST"></a> ARM_DISARM_REASON_UNIT_TEST | `uint8` | 13 | 
...
<a id="#NAVIGATION_STATE_FREE4"></a> NAVIGATION_STATE_FREE4 | `uint8` | 8 | 
...
<a id="#VEHICLE_TYPE_UNKNOWN"></a> VEHICLE_TYPE_UNKNOWN | `uint8` | 0 | 
...
<a id="#VEHICLE_TYPE_AIRSHIP"></a> VEHICLE_TYPE_AIRSHIP | `uint8` | 4 | 
...
[Source file (GitHub)](https://github.com/PX4/PX4-Autopilot/blob/main/msg/px4_msgs_old/msg/VehicleStatusV0.msg)
